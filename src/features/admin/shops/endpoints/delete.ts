...
import { deleteShopById } from '../admin-shops.service.js'

export function mountDeleteShop(router: FeatureRouter): void {
  router.delete(
    '/:id',
    ...adminOnly,
    ...
    async (context) => {
      ...
      const result = await deleteShopById(admin.id, id)
