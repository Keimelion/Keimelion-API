...
import { restoreItemById } from '../admin-items.service.js'

export function mountRestoreItem(router: FeatureRouter): void {
  router.post(
    '/:id/restore',
    ...adminOnly,
    ...
    async (context) => {
      ...
      return jsonResult(context, await restoreItemById(admin.id, id))
    },
  )
}
