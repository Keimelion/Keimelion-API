...
import { deleteItemById } from '../admin-items.service.js'

export function mountDeleteItem(router: FeatureRouter): void {
  router.delete(
    '/:id',
    ...adminOnly,
    ...
    async (context) => {
      ...
      return jsonResult(context, await deleteItemById(admin.id, id))
    },
  )
}
